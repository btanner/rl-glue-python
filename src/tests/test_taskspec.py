...
# Improving the test process_task_spec
#  $Revision$
#  $Date$
#  $Author$
#  $HeadURL$
...
tester = GlueTest("test_taskspec")


def process_task_spec(ts):
    ...
    if TaskSpec.valid:
        ...
        print "DiscountFactor: [%.3f]" % TaskSpec.getDiscountFactor()
        print "======================================================================================================="
        print "\t \t \t \t Observations"
        print "======================================================================================================="
