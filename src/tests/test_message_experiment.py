...
tester.check_fail(not (theResponse is not None or "" != theResponse));
...
tester.check_fail(
    "21111111111111111111111111111111111111111111111111111111311111111111111111111111111111111111111111111111111111113" != RLGlue.RL_env_message(
        "21111111111111111111111111111111111111111111111111111111311111111111111111111111111111111111111111111111111111113"));
tester.check_fail(
    "45555555555555555555555555555555555555555555555555555555655555555555555555555555555555555555555555555555555555559" != RLGlue.RL_agent_message(
        "45555555555555555555555555555555555555555555555555555555655555555555555555555555555555555555555555555555555555559"));
